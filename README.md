...
You can [download this image (zip-file, ca. 1.3 GB)](), unzip it and install it on your SD card (min. size 8 GB). We suggest tu use the [Raspberry Pi Imager](https://www.raspberrypi.org/downloads/) for this purpose.
