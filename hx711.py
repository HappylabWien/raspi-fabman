...
class HX711:
	...
	def getWeight(self):
		...
		#value = self.read()
		#print ("***** value (original) = " + str(value))
		#value -= self.OFFSET
		#print ("***** value (offset corrected) = " + str(value) + " (offset = " + str(self.OFFSET) + ")")
		
		value /= self.REFERENCE_UNIT
		#print ("***** value (referenced) = " + str(value) + " (ref = " + str(self.REFERENCE_UNIT) + ")")
